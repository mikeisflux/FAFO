...
<div style="background:#0d1117;border:1px solid #30363d;border-radius:8px;padding:24px;margin-bottom:32px;display:flex;gap:16px;align-items:flex-start;">
    ...
    <div>
        ...
        <p style="font-size:0.88rem;color:#8b949e;line-height:1.7;margin:0 0 6px;">
            All tips submitted through this form are confidential. We use TLS encryption on all form submissions. We do not share tip-source information with any government agency, law enforcement, or third party without a court order we intend to fight.
        </p>
        <p style="font-size:0.88rem;color:#8b949e;line-height:1.7;margin:0;">
            <strong style="color:#c9d1d9;">For maximum anonymity:</strong> Use the <a href="https://www.torproject.org/" target="_blank" rel="noopener noreferrer" style="color:#58a6ff;">Tor Browser</a> and access this page over a public Wi-Fi network not associated with you. Do not use a device issued by your employer.
        </p>
    </div>
</div>
...
<div style="background:#1c3a1c;border:1px solid #3fb950;color:#3fb950;padding:20px 24px;border-radius:6px;margin-bottom:24px;">
    ...
    <strong>Tip received securely.</strong> Thank you, patriot. Your information has been delivered to our investigative team. We review all tips and will act on credible leads.
</div>
<?php elseif ( ! empty( $tip_error ) ) : ?>
...
<div>
    ...
    <form method="post" action="">
        ...
        <div style="margin-bottom:16px;">
            <label style="display:block;font-weight:600;font-size:0.85rem;margin-bottom:6px;">
                Your Information <span style="font-weight:400;color:#888;">(Optional — leave blank to remain anonymous)</span>
            </label>
            <textarea name="tip_contact" rows="3" style="width:100%;padding:10px 14px;border:1px solid #ddd;border-radius:4px;font-size:0.95rem;resize:vertical;" placeholder="How can we reach you? (secure email, Signal number, etc.)&#10;You may leave this blank to submit completely anonymously."></textarea>
        </div>

        <div style="margin-bottom:20px;">
            <label style="display:block;font-weight:600;font-size:0.85rem;margin-bottom:6px;">
                Tip Details <span style="color:#C8102E;">*</span>
            </label>
            <textarea name="tip_message" required rows="10" style="width:100%;padding:10px 14px;border:1px solid #ddd;border-radius:4px;font-size:0.95rem;resize:vertical;" placeholder="Describe the information you have. Be as specific as possible:&#10;&#10;• Who is involved?&#10;• What happened or is happening?&#10;• When and where?&#10;• What evidence exists?&#10;• How did you come to know this?&#10;&#10;You may include links to documents, videos, or other evidence."></textarea>
        </div>
        ...
        <p style="font-size:0.78rem;color:#888;margin:10px 0 0;">By submitting a tip, you represent that the information is accurate to the best of your knowledge.</p>
    </form>
</div>
...
<div>
    ...
    <div style="display:flex;flex-direction:column;gap:16px;">
        <div style="background:#F5F5F0;padding:16px;border-radius:6px;border-left:3px solid #002868;">
            ...
            <p style="font-size:0.82rem;color:#555;line-height:1.6;margin:0;">FAFO News asserts journalist shield protections and will fight any subpoena seeking to identify our sources.</p>
        </div>
        <div style="background:#F5F5F0;padding:16px;border-radius:6px;border-left:3px solid #C8102E;">
            <h4 style="font-family:var(--font-head);font-size:0.8rem;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:#002868;margin:0 0 6px;"><i class="fas fa-lock"></i> &nbsp;Encrypted Communications</h4>
            <p style="font-size:0.82rem;color:#555;line-height:1.6;margin:0;">For ultra-sensitive tips, contact us via Signal or ProtonMail. Details available via initial contact form.</p>
        </div>
        <div style="background:#F5F5F0;padding:16px;border-radius:6px;border-left:3px solid #FFD700;">
        ...
        <div style="background:#F5F5F0;padding:16px;border-radius:6px;border-left:3px solid #555;">
            <h4 style="font-family:var(--font-head);font-size:0.8rem;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:#002868;margin:0 0 6px;"><i class="fas fa-ban"></i> &nbsp;We Don't Share</h4>
            <p style="font-size:0.82rem;color:#555;line-height:1.6;margin:0;">We will never voluntarily share your identity or contact information with any government agency, corporation, or other party.</p>
        </div>
    </div>

    <div style="margin-top:24px;background:#002868;color:#fff;padding:20px;border-radius:6px;">
        <h4 style="font-family:var(--font-head);font-size:0.82rem;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:#FFD700;margin:0 0 8px;">What We Cover</h4>
        <ul style="font-size:0.83rem;color:rgba(255,255,255,0.8);line-height:1.8;margin:0;padding-left:20px;">
            ...
            <li>Censorship and free speech violations</li>
        </ul>
    </div>
</div>
...
<aside class="sidebar" role="complementary">
    <div class="widget">
        <h3 class="widget-title"><i class="fas fa-shield-alt"></i> Tip Line</h3>
        <div class="widget-body">
            <p style="font-size:0.88rem;color:#555;line-height:1.6;margin:0 0 12px;">Your identity is protected. Submit tips anonymously or with contact info for follow-up.</p>
            <a href="<?php echo esc_url( fafo_page_link('contact') ); ?>" style="display:block;background:#002868;color:#fff;text-align:center;padding:10px;text-decoration:none;font-family:var(--font-head);font-weight:700;letter-spacing:0.06em;text-transform:uppercase;border-radius:4px;font-size:0.88rem;margin-top:8px;">Contact Newsroom</a>
        </div>
    </div>
